...
resource "vsphere_virtual_machine" "build_citrix-adc" {
  ...
  guest_id             = data.vsphere.ovf_vm_template.ovfLocal.guest_id
  scsi_type            = data.vsphere.ovf_vm_template.ovfLocal.scsi_type
  nested_hv_enabled    = data.vsphere.ovf_vm_template.ovfLocal.nested_hv_enabled
  ...
  ovf_deploy {
    ...
    local_ovf_path            = data.vsphere.ovf_vm_template.ovfLocal.local_ovf_path
    disk_provisioning         = data.vsphere.ovf_vm_template.ovfLocal.disk_provisioning
    ovf_network_map           = data.vsphere.ovf_vm_template.ovfLocal.ovf_network_map
  }
